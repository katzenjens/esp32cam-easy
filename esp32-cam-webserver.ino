...
void WifiSetup() {
    ...
    delay(100);
    flashLED(300);
    checkButton2(); // GPIO 2 Prüfen ob Taste gedrückt Funktioniert aus Gründen nur direkt beim Einschalten
...
void checkButton2(){  // Taste um Zugangsdaten zu löschen
  // check for button press
  Serial.println("GPIO2 prüfen...");
  unsigned long start = millis();
